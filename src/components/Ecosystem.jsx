      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            TheSparkNova is building a robust and interconnected ecosystem that fosters innovation, supports entrepreneurs, and drives economic growth across Bihar, UP, and beyond. We connect key stakeholders to create a vibrant environment for startups to flourish.
          </p>
        </div>
