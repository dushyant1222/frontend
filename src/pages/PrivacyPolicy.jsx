      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">User Provided Information</h3>
            <p className="text-gray-700 mb-4 leading-relaxed">
              The Application obtains the information you provide when you download and register the Application. 
              Registration with us is optional. However, please keep in mind that you may not be able to use some 
              of the features offered by the Application unless you register with us.
            </p>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-4 ml-4 space-y-1">
              ...
              <li>credit card information for purchase and use of the Application</li>
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              your mobile operating system, the type of mobile Internet browsers you use, and information about the way you use the Application.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              If SparkTank is involved in a merger, acquisition, or sale of all or a portion of its assets, 
              you will be notified via email and/or a prominent notice on our Web site of any change in ownership 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              You may use the standard uninstall processes as may be available as part of your mobile device or via 
              the mobile application marketplace or network. You can also request to opt-out via email, at 
              <a href="mailto:helloidea@sparktank.in" className="text-blue-600 hover:text-blue-800">helloidea@sparktank.in</a>.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Data Retention Policy, Managing Your Information</h2>
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              If you'd like us to delete User Provided Data that you have provided via the Application, please contact us at 
              <a href="mailto:helloidea@sparktank.in" className="text-blue-600 hover:text-blue-800">helloidea@sparktank.in</a> 
              and we will respond in a reasonable time. Please note that some or all of the User Provided Data may be required 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              We are concerned about safeguarding the confidentiality of your information. We provide physical, electronic, 
              and procedural safeguards to protect information we process and maintain. For example, we limit access to this 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              Privacy Policy by posting the new Privacy Policy here and informing you via email or text message. You are advised 
              to consult this Privacy Policy regularly for any changes, as continued use is deemed approval of all changes.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              and disclosing information, all of which activities will take place in India. If you reside outside India your 
              information will be transferred, processed and stored there under Indian privacy standards.
            </p>
          </section>
